...
const AboutUs = () => {
  return (
    <>
      <div className="my-3">
        <h1 className="bg-secondary font-bold text-[26px] text-primary w-1/3 p-3 text-center">
          About Us
        </h1>
      </div>

      <div className="flex flex-col items-center mx-1 sm:flex-row justify-evenly container">
